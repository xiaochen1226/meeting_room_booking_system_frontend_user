...
import { register, updatePassword, updatePasswordCaptcha } from "../../interface/interfaces";
...
export function UpdatePassword() {
    ...
    return <div id="updatePassword-container">
        ...
        <Form form={form} {...layout1} onFinish={onFinish} colon={false} autoComplete="off">
            ...
            <Form.Item label='邮箱' name="email" rules={[{required: true, message: '请输入邮箱！'},{type: 'email', message: '请输入合法邮箱'}]}>
                <Input />
            </Form.Item>
            ...
            <Form.Item {...layout1} label=' '>
                <Button className="btn" type="primary" htmlType="submit">修改</Button>
            </Form.Item>
        </Form>
    </div>
}