...
import { MeetingRoomSearchResult } from "../meeting-room-list/meeting-room-list";
import { bookingList, unbind, urge } from "../../interface/interfaces";
...
export function BookingHistory() {
    ...
    async function changUrge(id: number) {
        ...
        },
        {
            ...
            render: (_, record) => (
                record.status === '申请中' ? <div>
                    ...
                    <br/>
                    <a href="#" onClick={() => changUrge(record.id)}>催办</a>
                </div> : null
            )
        }
    ];
